...
public class Tickets extends JFrame implements ActionListener {
	...
	private void prepareGUI() {
		...
		if (chkIfAdmin == true) {
			...
			//keep empty so that non-admins don't have access to admin menu
		}
		 ...
		 */
			...
			try {
				...
				if(response.equals("Update Name")) {
					oldTicket = "Ticket_issuer";
					updatedTicket = JOptionPane.showInputDialog(null, "Enter new name");
					
				}
					
				else{
					oldTicket = "ticket_description";
					updatedTicket = JOptionPane.showInputDialog(null, "Enter new description");
					
							
					}
				// run updateRecords
				dao.updateRecords(ticketID, oldTicket, updatedTicket);
